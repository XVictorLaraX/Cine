...
class UbicacionPantalla extends StatefulWidget {
  const UbicacionPantalla({super.key});

  @override
  State<UbicacionPantalla> createState() => _UbicacionScreenState();
}

class _UbicacionScreenState extends State<UbicacionPantalla>
