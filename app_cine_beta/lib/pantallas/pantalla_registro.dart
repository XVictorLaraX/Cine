...
class RegistroUsuariosPantalla extends StatefulWidget {
  const RegistroUsuariosPantalla({super.key});

  @override
  State<RegistroUsuariosPantalla> createState() => _RegisterScreenState();
}

class _RegisterScreenState extends State<RegistroUsuariosPantalla> {
